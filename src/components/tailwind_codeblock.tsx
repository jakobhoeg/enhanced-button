...
import {tailwindCode} from "@/code";
  

export default function TailwindCodeblock() { 
  ...
  return ( 
    <div className="md:max-w-3xl max-w-sm overflow-hidden flex flex-col rounded-l-lg  text-start shadow-xl "> 
